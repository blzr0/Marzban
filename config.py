...
ACTIVE_STATUS_EMOJI = config("ACTIVE_STATUS_EMOJI", default="✅")
EXPIRED_STATUS_EMOJI = config("EXPIRED_STATUS_EMOJI", default="⌛️")
LIMITED_STATUS_EMOJI = config("LIMITED_STATUS_EMOJI", default="🪫")
DISABLED_STATUS_EMOJI = config("DISABLED_STATUS_EMOJI", default="❌")
ONHOLD_STATUS_EMOJI = config("ONHOLD_STATUS_EMOJI", default="🔌")
